...
experiments = [
    ...
    [500, 300, 0.9, 0.2, fps, swap_mutation, two_point_xo, True],
    [500, 300, 0.9, 0.2, fps, swap_mutation, uniform_xo, True],
    [500, 300, 0.9, 0.2, fps, swap_mutation, arithmetic_xo, True],
    [500, 300, 0.9, 0.2, fps, swap_mutation, blend_xo, True],
    [500, 300, 0.9, 0.2, fps, swap_mutation, blx_alpha_xo, True],
    [500, 300, 0.9, 0.2, fps, swap_mutation, order_one_xo, True]]
...
if __name__ == '__main__':
    ...
    def create_labels(experiments):
        ...
        for exp in experiments:
            label_parts = []
            label_parts.append(f"{exp[6].__name__}") # Crossovers
