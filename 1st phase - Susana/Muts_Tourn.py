...
experiments = [
    ...
    [500, 300, 0.9, 0.2, tournament_sel, random_reseting, single_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, inversion_mutation, single_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, scramble_mutation, single_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, centre_inverse_mutation, single_point_xo, True]]
