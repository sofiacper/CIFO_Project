...
experiments = [
    ...
    [500, 300, 0.9, 0.2, rank_sel, random_reseting, single_point_xo, True],
    [500, 300, 0.9, 0.2, rank_sel, inversion_mutation, single_point_xo, True],
    [500, 300, 0.9, 0.2, rank_sel, scramble_mutation, single_point_xo, True],
    [500, 300, 0.9, 0.2, rank_sel, centre_inverse_mutation, single_point_xo, True]]
