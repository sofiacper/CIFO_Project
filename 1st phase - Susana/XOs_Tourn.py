...
# Crossovers
experiments = [
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, single_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, two_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, uniform_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, arithmetic_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, blend_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, blx_alpha_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, swap_mutation, order_one_xo, True]]
