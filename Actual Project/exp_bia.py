...
'''
experiments = [
    [300, 100, 0.9, 0.2, fps, swap_mutation, single_point_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, two_point_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, uniform_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, arithmetic_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, blend_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, blx_alpha_xo, True],
    [300, 100, 0.9, 0.2, fps, swap_mutation, order_one_xo, True]
]
'''
experiments = [
    [300, 100, 0.9, 0.2, fps, swap_mutation, single_point_xo, True],
    [300, 100, 0.9, 0.2, fps, random_reseting, single_point_xo, True],
    [300, 100, 0.9, 0.2, fps, inversion_mutation, single_point_xo, True],
    [300, 100, 0.9, 0.2, fps, scramble_mutation, single_point_xo, True],
    [300, 100, 0.9, 0.2, fps, centre_inverse_mutation, single_point_xo, True]
]
