"""
rank_sel throws
AttributeError: 'Population' object has no attribute 'sorted'
"""
...
"""
# RANK - XO: single_point_xo - M: swap_mut                       (889-854, 878-859)
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
# xo=single_point_xo, mutate=swap_mutation, elitism=True)


# RANK - XO: single_point_xo - M: random_resetting               (884-847, 875-832)
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
# xo=single_point_xo, mutate=random_reseting, elitism=True)


# RANK - XO: single_point_xo - M: inversion_mutation             (874-775, 866-848)
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
# xo=single_point_xo, mutate=inversion_mutation, elitism=True)


# RANK - XO: single_point_xo - M: scramble_mutation              (
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
# xo=single_point_xo, mutate=scramble_mutation, elitism=True)


# RANK - XO: single_point_xo - M: centre_inverse_mutation        (
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
...
"""
# RANK - XO: two_point_xo - M: swap_mut                       (
# P.evolve(gens=500, xo_prob=0.9, mut_prob=0.15, select=rank_sel,
