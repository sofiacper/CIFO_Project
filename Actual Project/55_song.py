...
from charles.xo import single_point_xo, multi_point_xo, uniform_xo, pm_xo
...
P.evolve(gens=10, xo_prob=0.9, mut_prob=0.15, select=fps, xo=uniform_xo, mutate=swap_mutation, elitism=True)
