...
from charles.mutation import random_reseting
from charles.xo import two_point_xo, uniform_xo
...
# Crossovers
experiments = [
    [500, 300, 0.9, 0.2, tournament_sel, random_reseting, two_point_xo, True],
    [500, 300, 0.9, 0.2, tournament_sel, random_reseting, uniform_xo, True]]
